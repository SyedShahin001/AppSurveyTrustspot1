...
using System.Text;
using AppSurveyTrustspot.Controllers;
...
public class AdminController : ControllerBase
{
    ...
    public AdminController(TrustspotContext context, ILogger<AdminController> logger, IConfiguration configuration)
    {
        _context = context;
...
{
      new Claim(JwtRegisteredClaimNames.Email, loginModel.EmailAddress),
    ...
    public ActionResult Index()
    {
        ...
        _logger.LogInformation("Log message from Warning method");
